...
async fn main() -> std::io::Result<()> {
    ...
    for _ in 0..CLIENT_COUNT {
        ...
        tokio::spawn(async move {
            ...
            let _ = socket.send_to(&connect_packet, &server_addr).await;
    ...
    let packet_loss = if total_sent > 0 {
        100.0 * (total_sent - total_received) as f64 / total_sent as f64
    } else { 0.0 };
