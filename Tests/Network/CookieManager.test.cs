...
namespace Tests
{
    public class CookieManagerTests : AbstractTest
    {
        public CookieManagerTests()
        {
            Describe("CookieManager Cookie Generation", () =>
            {
                It("should generate valid cookies for different addresses", () =>
                {
                    ...
                    byte[] cookie1 = CookieManager.GenerateCookie(address1);
                    byte[] cookie2 = CookieManager.GenerateCookie(address2);
                ...
                It("should generate different cookies for same address on subsequent calls", () =>
                {
                    ...
                    byte[] cookie1 = CookieManager.GenerateCookie(address);
                    byte[] cookie2 = CookieManager.GenerateCookie(address);
                ...
                It("should generate cookies with correct structure", () =>
                {
                    ...
                    byte[] cookie = CookieManager.GenerateCookie(address);
                ...
                It("should handle localhost address", () =>
                {
                    ...
                    byte[] cookie = CookieManager.GenerateCookie(localhost);
            ...
            Describe("CookieManager Cookie Validation", () =>
            {
                It("should validate freshly generated cookies", () =>
                {
                    ...
                    bool isValid = CookieManager.ValidateCookie(cookie, address);
                ...
                It("should reject cookies with wrong length", () =>
                {
                    ...
                    bool isValid = CookieManager.ValidateCookie(invalidCookie, address);
                ...
                It("should reject null cookies", () =>
                {
                    ...
                    bool isValid = CookieManager.ValidateCookie(null, address);
                    Expect(isValid).ToBe(false);
                });
                ...
                It("should reject empty cookies", () =>
                {
                    ...
                    bool isValid = CookieManager.ValidateCookie(emptyCookie, address);
                    Expect(isValid).ToBe(false);
                });
                ...
                It("should reject cookies for different addresses", () =>
                {
                    ...
                    byte[] cookie = CookieManager.GenerateCookie(address1);
                    bool isValid = CookieManager.ValidateCookie(cookie, address2);
                ...
                It("should handle validation of multiple cookies concurrently", () =>
                {
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        ...
                        cookies[i] = CookieManager.GenerateCookie(addresses[i]);
                    }
                    ...
                    {
                        int index = i; 
                        tasks[i] = Task.Run(() => CookieManager.ValidateCookie(cookies[index], addresses[index]));
                    }
            ...
            Describe("CookieManager Cookie Expiration", () =>
            {
            ...
            Describe("CookieManager Security Properties", () =>
            {
                It("should generate unique random components", () =>
                {
                    ...
                    for (int i = 0; i < 5; i++)
                    {
                        cookies[i] = CookieManager.GenerateCookie(address);
                    }
                ...
                It("should handle concurrent cookie generation safely", () =>
                {
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        ...
                        tasks[i] = Task.Run(() =>
                        {
                            cookies[index] = CookieManager.GenerateCookie(address);
                        });
                    }
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        ...
                        bool isValid = CookieManager.ValidateCookie(cookies[i], address);
                        Expect(isValid).ToBe(true);
                    }
                ...
                It("should handle different port numbers for same IP", () =>
                {
                    ...
                    Expect(identical).ToBe(false);
                    Expect(CookieManager.ValidateCookie(cookie1, address1)).ToBe(true);
                    Expect(CookieManager.ValidateCookie(cookie1, address2)).ToBe(false);
                    Expect(CookieManager.ValidateCookie(cookie2, address1)).ToBe(false);
                    Expect(CookieManager.ValidateCookie(cookie2, address2)).ToBe(true);
                });
            });
        }
        ...
        {
            var field = typeof(CookieManager).GetField("ServerSecret",
